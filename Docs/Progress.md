...
- Publicación y deploy por GitHub en preparación. No se emitieron órdenes reales; falta la adopción operativa de posiciones y el posterior corte para reinstalar sin n8n. El deploy fija la imagen al SHA verificado, conserva imágenes anteriores y mantiene la adopción nativa apagada.
